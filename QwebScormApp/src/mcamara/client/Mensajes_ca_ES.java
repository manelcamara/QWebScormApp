...
/**
 * The Interface Mensajes_ca_ES: interface que s'utilitza per a presentar els missatges
 * en català de l'aplicació
 */
public interface Mensajes_ca_ES extends Mensajes {
